...
<?php
    ...
    if(!isset($_SESSION['admin'])){
        ...
        echo "<span class=welcomee> Welcome " . $_SESSION['admin']."</span><br>";
        $obj = new maincls();
        $r = $obj->checkUser($_GET['Name']);
        foreach($r as $v){
            $event = explode(',',$v[3]);
            ?>
...
if(isset($_REQUEST['sub']))
{
    ...
    $r = $obj->updateUser($_REQUEST['password'], $_REQUEST['contact'],$event,$_REQUEST['username'] );
    if($r == 1)
    {
